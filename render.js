var ucmmap = (function(){
    ...
    kmlDataSources = {
        lefkosia_district: dBaseUrl + 'lefkosia-district-'+ lang +'.kml?t=' + ( local ? Date.now() : 'v1' ),
        larnaka_district: dBaseUrl + 'larnaka-district-'+ lang +'.kml?t=' + ( local ? Date.now() : 'v1' ),
        ammochostos_district: dBaseUrl + 'ammochostos-district-'+ lang +'.kml?t=' + ( local ? Date.now() : 'v1' ),
        lemesos_district: dBaseUrl + 'lemesos-district-'+ lang +'.kml?t=' + ( local ? Date.now() : 'v1' ),
        keryneia_district: dBaseUrl + 'keryneia-district-'+ lang +'.kml?t=' + ( local ? Date.now() : 'v1' ),
        paphos_district: dBaseUrl + 'paphos-district-'+ lang +'.kml?t=' + ( local ? Date.now() : 'v1' ),
    },
    layers = {},
    districts_coords = {
